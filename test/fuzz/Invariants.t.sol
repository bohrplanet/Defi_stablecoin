...
contract Invariants is StdInvariant, Test {
    ...
    // You can image that every time invariant test will go handler to do some money test(according to depth),
    // then create a random situation of contract, then begin to run invariant_XXX() function,
    // and if some logic fail in invariant_XXX() function, then it will fail
